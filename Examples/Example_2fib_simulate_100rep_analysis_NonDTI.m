...
fod1_s = [1 0 0]; %%0,0,1; z-[0 0 1] [ sqrt(3)/2 0  1/2] [0.7071 0  0.7071] [1/2 0  sqrt(3)/2] [0.9659 0 0.2588] [sqrt(3)/2 0 1/2]  [0.7660 0  0.6428]
...
for rep = 1:N_rep
    ...
    folder_path = strcat(path_save,'simulation_review/','2fib_sep',num2str(round(sep*180/pi,0)),'_lmax',num2str(lmax),'_b',num2str(b(1)),'_ratio',num2str(ratio(1)),'_n',num2str(n_sample),'_sig',num2str(sigma),'_SH',num2str(DTI_lmax),'/');
...
%%%%%
angle1_std_SH_lmax8 = std(angle1_SH_lmax8(nfib_SH_lmax8==2));
angle1_std_sCSD_lmax8 = std(angle1_sCSD_lmax8(nfib_sCSD_lmax8==2));
angle1_std_sCSD_lmax12 = std(angle1_sCSD_lmax12(nfib_sCSD_lmax12==2));
angle1_std_sCSD_lmax16 = std(angle1_sCSD_lmax16(nfib_sCSD_lmax16==2));
angle1_std_SN = std(angle1_SN(nfib_SN==2));
...
input.data = [SH_input;sCSD8_input;sCSD12_input;sCSD16_input;SN_input];

input.tableColLabels = {'Correct','Under','Over', 'Error-1', 'Error-2', 'Mean Sep.', 'Mean H-dist.', 'SD H-dist.'};
input.tableRowLabels = {'SH-ridge','SCSD8','SCSD12', 'SCSD16', 'SN-lasso'};
