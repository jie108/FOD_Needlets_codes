...
ratio = [10,10,20]; % ratio of the leading eigenvalue to the second eigenvalue in the signal simulation
weight = [0.3,0.3,0.4];
...
for rep = 1:N_rep
    ...
    folder_path = strcat(path_save,'simulation_review/','3fib_sep',num2str(round(sep*180/pi,0)),'_lmax',num2str(lmax),'_b',num2str(b(1)),'_ratio',num2str(ratio(1)),'_n',num2str(n_sample),'_sig',num2str(sigma),'/');
