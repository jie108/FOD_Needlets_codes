...
sep1_sd = sd(sep1_DiST[nfib_DiST==3])
sep2_sd = sd(sep1_DiST[nfib_DiST==3])
sep3_sd = sd(sep1_DiST[nfib_DiST==3])
...
writeMat(mat_file, nfib_DiST=nfib_DiST, angle1_DiST=angle1_DiST, 
         ...
         angle3_DiST_mean=angle3_DiST_mean,
         angle1_DiST_sd=angle1_DiST_sd, angle2_DiST_sd=angle2_DiST_sd, 
         angle3_DiST_sd=angle3_DiST_sd, sep1_mean=sep1_mean,sep2_mean=sep2_mean,
         sep3_mean=sep3_mean,sep1_sd=sep1_sd,sep2_sd=sep2_sd,sep3_sd=sep3_sd
         )
