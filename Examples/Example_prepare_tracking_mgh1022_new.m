...
b = 3000;
load(strcat(path_folder,'fitting_b',num2str(b/1000),'_',voxel_sub,'/','space_index', voxel_sub,'.mat'));
...
savepath = strcat(path_folder,'fitting_b',num2str(b/1000),'_',voxel_sub,'/');
