...
path_load = '/Users/hao/Dropbox/stats_project/FOD_codes_simulation/Real_data/S110933/fitting_x108-123y124-139z37-42/'
num_fib_cut = 4
x_subr = 1:16;
y_subr = 1:16;
z_subr = 4:4;
...
title3d(main=paste0('New_S110933_cut',toString(num_fib_cut),'_numfib',toString(ndis)),pos=c(15,15,15))
