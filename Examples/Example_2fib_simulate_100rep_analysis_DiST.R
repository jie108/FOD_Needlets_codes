...
folder_name = paste0('2fib_sep',toString(sep),'_lmax',toString(lmax),'_b',toString(b),
                     '_ratio',toString(ratio),'_n',toString(n_sample),'_sig0.05','_SH',toString(DTI_lmax),'/')
...
sep_sd = mean(sep_DiST[nfib_DiST==2])
...
save(nfib_DiST, angle1_DiST, angle2_DiST, sep_DiST, theta1_DiST, theta2_DiST,
     ...
     correct_DiST, over_DiST, under_DiST, angle1_DiST_mean, angle2_DiST_mean,
     angle1_DiST_sd, angle2_DiST_sd, sep_mean, sep_sd,
...
writeMat(mat_file, nfib_DiST=nfib_DiST, angle1_DiST=angle1_DiST, 
         ...
         sep_mean=sep_mean, sep_sd=sep_sd,
