...
fod_sele_SN_RSSdiff_use = fod_sele_SN_RSSdiff(x_subr,y_subr,z_subr);
...
for k=1:nn3
    for j=1:nn2
        for i=1:nn1
            ...
            %%%%%%%%%%%%%%%%%%%%%%%%%%
            [~, ~, ~, ~, ~, peak_pos_SN_final_RSSdiff] = FOD_peak(fod_sele_SN_RSSdiff_use(i,j,k,:), Dis, kmin, peak_thresh, pos_p, theta_p, phi_p);
