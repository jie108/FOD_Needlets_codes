...
folder_path = strcat('/Users/hao/Dropbox/stats_project/FOD_codes_simulation/simulation_review/','3fib','_sep',num2str(separation),'_lmax',num2str(lmax),'_b',num2str(b(1)),'_ratio',num2str(ratio(1)),'_n',num2str(n_sample),'_sig',num2str(sigma),'/');    
% folder_path = strcat('/Users/hao/Dropbox/stats_project/FOD_codes_simulation/simulation_review/','3fib','_sep',num2str(separation),'_lmax',num2str(lmax),'_b',num2str(b(1)),'_ratio',num2str(ratio(1)),'_n',num2str(n_sample),'_sig',num2str(sigma),'_SH4/');    
...
% folder_path = strcat('/Users/hao/Dropbox/stats_project/FOD_codes_simulation/simulation_new_results/','3fib_sep',num2str(separation),'_lmax',num2str(lmax),'_b',num2str(b(1)),'_ratio',num2str(ratio(1)),'_n',num2str(n_sample),'_sig',num2str(sigma),'/');    
...
%     temp_name = strcat('2fib_sep',num2str(separation),'_lmax',num2str(lmax),'_b',num2str(b(1)),'_ratio',num2str(ratio(1)),'_n',num2str(n_sample),'_sig',num2str(sigma),'_rep',num2str(rep),'.mat');
    temp_name = strcat('3fib_sep',num2str(separation),'_lmax',num2str(lmax),'_b',num2str(b(1)),'_ratio',num2str(ratio(1)),'_n',num2str(n_sample),'_sig',num2str(sigma),'_rep',num2str(rep),'.mat');
