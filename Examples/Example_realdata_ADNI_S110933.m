...
path_folder_sub = strcat(path_save, subject_id,'/Nii_FSL_related/');
...
%% real data range
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
x_range = 108:123; %71:105;%71:120; %86:95; %71:105;  %71:110; %120:124;  %100:155    101:160
y_range = 124:139; %41:125;%46:145; %86:90;  %41:130; %137:141;  %87:148     91:180;   
z_range = 37:42; %51:90;%51:100; %71:85; %61:90;  %46:105; %38:40;    %21:47      21:50;
...
save_path = strcat(path_folder,'fitting_',voxel_sub,'/'); 
mkdir(save_path);
...
%% load nii data (raw)
bvec_raw = load('027_S_2245_2011-06-06_16_21_14.0_S110933.rotated.bvec'); 
...
nii_FA = load_nii(strcat(path_folder_sub,'dti_FA.nii.gz'));
nii_MD = load_nii(strcat(path_folder_sub,'dti_MD.nii.gz'));
nii_S0 = load_nii(strcat(path_folder_sub,'dti_S0.nii.gz'));

nii_V1 = load_nii(strcat(path_folder_sub,'dti_V1.nii.gz'));
nii_V2 = load_nii(strcat(path_folder_sub,'dti_V2.nii.gz'));
nii_V3 = load_nii(strcat(path_folder_sub,'dti_V3.nii.gz'));

nii_L1 = load_nii(strcat(path_folder_sub,'dti_L1.nii.gz'));
nii_L2 = load_nii(strcat(path_folder_sub,'dti_L2.nii.gz'));
nii_L3 = load_nii(strcat(path_folder_sub,'dti_L3.nii.gz'));
...
%% pre-analysis
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
x_pre = 71:105; %71:105;%71:120; %86:95; %71:105;  %71:110; %120:124;  %100:155    101:160
y_pre = 91:135; %41:125;%46:145; %86:90;  %41:130; %137:141;  %87:148     91:180;   
z_pre = 21:50; %51:90;%51:100; %71:85; %61:90;  %46:105; %38:40;    %21:47      21:50;
...
subplot(2,3,6)
scatter(FA_show_pre,MD_show_pre)
set(gca, 'FontSize', 15)
...
%         colorbar;
        ...
        %% MD map
        MD_temp_map_fsl = dti_data_reindex(img_MD_fsl(:,:,i3)*1e3);
...
%         Eig1_fig = figure;
        ...
        display(i1);
        savefig(strcat(save_path,'FA_MD_color_z',num2str(i3),'.fig'))
        saveas(gcf,strcat(save_path,'figure/FA_MD_color_z',num2str(i3),'.png'));
        close(gcf);
    end
%     options.use_axis = 0;
...
lambda_min_la = 1e-5;
lambda_max_la = 10^(0.0204);
lambda_length_la = 124;
...
save(strcat(save_path,'newnew_space_index', voxel_sub,'.mat'),'-v7.3');
...
%                     alpha(0.25)
            ...
            hold off;
            savefig(strcat(save_path,'newnew_SN','_z', num2str(i3),'.fig'));          
            saveas(gcf,strcat(save_path,'figure/newnew_SN_z',num2str(i3),'.png')) 
            close(gcf);
            display(i3);
