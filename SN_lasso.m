...
function [beta_est_all, z_all, w_all, dwi_est_all, df_all, df_rank_all, RSS_all, stop_criterion, index_stop] ...
...
%% index_stop: the index of first lambda that selected by relativeRSS_thresh
